...
#[wasm_bindgen]
impl Image {
    pub fn scale(&mut self, w: u32, h: u32, buff: Vec<u8>, factor: f64) {
        let new_width = (self.width as f64 * factor).floor() as u32; // use floor to avoid out-of-bound-interpolation
        let new_height = (self.height as f64 * factor).floor() as u32;
        ...
        for row in 0..new_height {
            for col in 0..new_width {
                ...
                //self.log.push((col as f64 / factor, row as f64 / factor));
