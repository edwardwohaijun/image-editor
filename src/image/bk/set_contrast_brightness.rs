...
impl Image {
    ...
    // pass a 2nd parameter, [-5, -4, -3, -1, 0, 1, 2, 3, 4, 5], default is at 0 position
    // 一旦'apply', the new img replace the old one, the slider reposition itself to 0 position.
    pub fn set_contrast_brightness(&mut self) { // (&mut self, "contrast/brightness", 2)
